...
class UndefHijack {
    ...
    _ensureTerm() {
        ...
        if (fitAddonGlobal) {
            ...
            this._ro = new ResizeObserver(() => { try {
                this._fitAddon.fit();
            }
            catch (_) { } });
    ...
    _updateButtons() {
        ...
        if (stepBtn)
            stepBtn.disabled = hideHijack || !this._hijackedByMe;
        if (releaseBtn)
...
if (typeof window !== 'undefined')
    ( /** @type {any} */(window)).UndefHijack = UndefHijack;
