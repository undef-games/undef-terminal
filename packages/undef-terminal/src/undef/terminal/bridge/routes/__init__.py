...
Mount via :meth:`~undef.terminal.bridge.hub.TermHub.create_router`::
...
from undef.terminal.bridge.routes.rest import register_rest_routes as register_rest_routes
from undef.terminal.bridge.routes.websockets import register_ws_routes as register_ws_routes
