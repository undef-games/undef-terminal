...
from undef.terminal.bridge.hub.resume import InMemoryResumeStore, ResumeSession, ResumeTokenStore
...
class TestInMemoryResumeStore:
    ...
    def test_ttl_respected(self) -> None:
        store = InMemoryResumeStore()
        with patch("undef.terminal.bridge.hub.resume.time") as mock_time:
