...
def test_idle_loops_still_cleanup_expired_hijack() -> None:
    ...
    with (
        patch("undef.terminal.bridge.routes.websockets._WORKER_HIJACK_CLEANUP_INTERVAL_S", 0.05),
        patch("undef.terminal.bridge.routes.websockets._BROWSER_HIJACK_CLEANUP_INTERVAL_S", 0.05),
    ):
