...
::
    ...
    DO.webSocketMessage() → push_worker_input(data)
          ↓
    _ushell.handle_input(data)   ← UshellConnector (undef.terminal.shell.terminal)
          ↓
    list[term frames]
          ↓
...
def _load_connector(session_id: str, env: Any, storage: Any = None) -> Any:
    ...
    try:
        ...
        from undef.terminal.shell.terminal._connector import UshellConnector  # type: ignore[import-not-found]
