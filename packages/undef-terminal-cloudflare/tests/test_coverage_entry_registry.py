...
def test_resolve_spa_route_root() -> None:
    from undef.terminal.cloudflare.entry import _resolve_spa_route
...
def test_spa_response_dashboard() -> None:
    from undef.terminal.cloudflare.entry import _spa_response
...
def test_has_cf_service_token_with_access_suffix() -> None:
    from undef.terminal.cloudflare.entry import _has_cf_service_token
...
async def test_handle_connect_post_creates_session() -> None:
    from undef.terminal.cloudflare.entry import _handle_connect
...
async def test_handle_sessions_delete_purges_kv() -> None:
    ...
    from undef.terminal.cloudflare.entry import _handle_sessions
...
async def test_handle_session_delete_forwards_to_do() -> None:
    ...
    from undef.terminal.cloudflare.entry import _handle_session_delete
    ...
    with patch("undef.terminal.cloudflare.entry.delete_kv_session", new=AsyncMock()) as mock_del:
...
async def test_handle_session_delete_no_do_binding() -> None:
    ...
    with patch("undef.terminal.cloudflare.entry.delete_kv_session", new=AsyncMock()):
...
async def test_delete_kv_session_deletes_key() -> None:
    from undef.terminal.cloudflare.state.registry import delete_kv_session
