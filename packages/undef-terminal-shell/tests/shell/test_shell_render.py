...
#
"""Tests for undef.terminal.shell._render — ANSI image rendering."""
...
def test_pillow_import_error_raises_helpful_message() -> None:
    ...
    import undef.terminal.shell._render as render_mod
...
def test_render_frame_odd_height_last_row_padding() -> None:
    ...
    from undef.terminal.shell._render import _render_frame
    from undef.terminal.shell._render import _sgr_truecolor as sgr_fn
